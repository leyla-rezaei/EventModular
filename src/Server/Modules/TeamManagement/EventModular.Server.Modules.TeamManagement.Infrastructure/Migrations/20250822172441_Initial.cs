    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizerRole", x => x.Id);
                });

            migrationBuilder.CreateTable(
                name: "OrganizerRoleLocalization",
                schema: "localization",
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizerRoleLocalization", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrganizerRoleLocalization_OrganizerRole_OrganizerRoleId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizerRolePermission", x => x.Id);
                    table.ForeignKey(
                        name: "FK_OrganizerRolePermission_OrganizerRole_OrganizerRoleId",
                        column: x => x.OrganizerRoleId,
                        principalSchema: "teamManagement",
                        principalTable: "OrganizerRole",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizerRoleLocalization_OrganizerRoleId",
                schema: "localization",
                table: "OrganizerRoleLocalization",
                column: "OrganizerRoleId");

            migrationBuilder.CreateIndex(
                name: "IX_OrganizerRolePermission_OrganizerRoleId",
                schema: "teamManagement",
                table: "OrganizerRolePermission",
                column: "OrganizerRoleId");
        }
