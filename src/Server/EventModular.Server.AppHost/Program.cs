...
var sqlDatabase = builder.AddSqlServer("sqlserver")
        ...
        .WithVolume("/var/lib/sql-server/EventModular/data")
        .WithImage("mssql/server", "2025-latest")
        .AddDatabase("sqldb"); // Sql server 2025 supports embedded vector search.


var serverWebProject = builder.AddProject<EventModular_Server_Web>("serverweb") // Replace . with _ if needed to ensure the project builds successfully.
