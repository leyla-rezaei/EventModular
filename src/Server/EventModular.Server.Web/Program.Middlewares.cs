...
using EventModular.Shared;
using EventModular.Shared.Attributes;
using Hangfire;
using EventModular.Server.Api;
using EventModular.Server.Api.Filters;
using EventModular.Server.Api.Services;
using EventModular.Server.Web.Endpoints;

namespace EventModular.Server.Web;
...
public static partial class Program
{
    ...
    public static void ConfigureMiddlewares(this WebApplication app)
    {
        ...
        {
            options.InjectJavascript($"/_content/EventModular.Server.Api/scripts/swagger-utils.js?v={Environment.TickCount64}");
        });
        ...
        var blazorApp = app.MapRazorComponents<Components.App>()
            ...
            .AddAdditionalAssemblies(AssemblyLoadContext.Default.Assemblies.Where(asm => asm.GetName().Name?.Contains("EventModular.Client") is true).ToArray());
