...
namespace EventModular.Server.Web.Services;
...
public class ScssCompilerService
{
    internal static async Task WatchScssFiles(WebApplication app)
    {
        ...
        var clientCorePath = Path.Combine(Environment.CurrentDirectory, "../../Client/EventModular.Client.Core");
        ...
        // but uses ../../Client/EventModular.Client.Web:../../Client/EventModular.Client.Web instead of .:.,
        ...
        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/EventModular.Client.Maui/Components")))
            sassPathsToWatch.Add("../../Client/EventModular.Client.Maui/Components:../../Client/EventModular.Client.Maui/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/EventModular.Client.Windows/Components")))
            sassPathsToWatch.Add("../../Client/EventModular.Client.Windows/Components:../../Client/EventModular.Client.Windows/Components");

        if (Path.Exists(Path.Combine(Environment.CurrentDirectory, "../../Client/EventModular.Client.Web/Components")))
            sassPathsToWatch.Add("../../Client/EventModular.Client.Web/Components:../../Client/EventModular.Client.Web/Components");
