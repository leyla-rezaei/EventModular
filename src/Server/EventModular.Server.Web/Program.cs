using EventModular.Server.Api.Data;
using EventModular.Server.Web.Services;
using EventModular.Client.Core.Services.Contracts;
...
public static partial class Program
{
    public static async Task Main(string[] args)
    {
        ...
        builder.Configuration.AddClientConfigurations(clientEntryAssemblyName: "EventModular.Client.Web");
