...
namespace EventModular.Server.Api.Migrations
{
    ...
    [Migration("20250806153155_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Attachments.Attachment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Categories.Category", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Chatbot.SystemPrompt", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Identity.Role", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Identity.RoleClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Identity.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Identity.UserClaim", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Identity.UserLogin", b =>
                {
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Identity.UserRole", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Identity.UserSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Identity.UserToken", b =>
                {
                    b.Property<Guid>("UserId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Identity.WebAuthnCredential", b =>
                {
                    b.Property<byte[]>("Id")
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = new byte[] { 0, 0, 0, 0, 0, 0, 0, 0 },
                            CreatedOn = new DateTimeOffset(new DateTime(2025, 7, 25, 0, 0, 0, 0, DateTimeKind.Unspecified), new TimeSpan(0, 0, 0, 0, 0)),
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.PushNotification.PushNotificationSubscription", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Todo.TodoItem", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier")
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Identity.RoleClaim", b =>
                {
                    b.HasOne("EventModular.Server.Api.Models.Identity.Role", "Role")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Identity.UserClaim", b =>
                {
                    b.HasOne("EventModular.Server.Api.Models.Identity.User", "User")
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.Products.Product", b =>
                {
                    b.HasOne("EventModular.Server.Api.Models.Categories.Category", "Category")
                        .WithMany("Products")
            ...
            modelBuilder.Entity("EventModular.Server.Api.Models.PushNotification.PushNotificationSubscription", b =>
                {
                    b.HasOne("EventModular.Server.Api.Models.Identity.UserSession", "UserSession")
                        .WithOne("PushNotificationSubscription")
                        .HasForeignKey("EventModular.Server.Api.Models.PushNotification.PushNotificationSubscription", "UserSessionId")
