...
using EventModular.Server.Api.Controllers;
using EventModular.Server.Shared.Services;
using EventModular.Server.Api.Services.Jobs;
using EventModular.Server.Api.Models.Identity;
using EventModular.Server.Api.Services.Identity;
...
public static partial class Program
{
    public static void AddServerApiProjectServices(this WebApplicationBuilder builder)
    {
        ...
        services.AddScoped(sp =>
        {
            ...
            var options = new Fido2Configuration
            {
                ...
                ServerName = "EventModular WebAuthn",
        ...
        builder.Services.AddHangfire(configuration =>
        {
            var efCoreStorage = configuration.UseEFCoreStorage(optionsBuilder =>
            {
                ...
                {
                    var connectionString = "Data Source=EventModularJobs.db;Mode=Memory;Cache=Shared;";
    ...
    private static void AddSwaggerGen(WebApplicationBuilder builder)
    {
        ...
        {
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "EventModular.Server.Api.xml"), includeControllerXmlComments: true);
            options.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "EventModular.Shared.xml"));
