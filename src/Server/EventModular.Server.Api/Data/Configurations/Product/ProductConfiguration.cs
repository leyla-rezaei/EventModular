using EventModular.Server.Api.Models.Products;

namespace EventModular.Server.Api.Data.Configurations.Identity;
...
public partial class ProductConfiguration : IEntityTypeConfiguration<Product>
{
    public void Configure(EntityTypeBuilder<Product> builder)
    {
        ...
        DateTimeOffset baseDate = DateTimeOffset.Parse("2025-08-04", styles: DateTimeStyles.AssumeUniversal);
