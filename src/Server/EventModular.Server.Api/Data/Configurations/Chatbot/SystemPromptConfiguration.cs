...
namespace EventModular.Server.Api.Data.Configurations.Chatbot;
...
public class SystemPromptConfiguration : IEntityTypeConfiguration<SystemPrompt>
{
    public void Configure(EntityTypeBuilder<SystemPrompt> builder)
    {
        ...
        builder.HasData(new SystemPrompt
        {
            ...
            Markdown = @"You are a assistant for the EventModular app. Below, you will find a markdown document containing information about the app, followed by the user's query.
