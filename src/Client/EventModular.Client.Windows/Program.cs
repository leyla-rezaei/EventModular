...
using EventModular.Client.Core.Components;
using EventModular.Client.Windows.Services;
using Microsoft.Extensions.Logging;
using Microsoft.AspNetCore.Components.WebView.WindowsForms;
using Velopack.Logging;

namespace EventModular.Client.Windows;
...
public partial class Program
{
    ...
    public static void Main(string[] args)
    {
        ...
        var configuration = new ConfigurationBuilder().AddClientConfigurations(clientEntryAssemblyName: "EventModular.Client.Windows").Build();
