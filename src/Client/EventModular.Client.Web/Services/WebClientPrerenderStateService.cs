...
namespace EventModular.Client.Web.Services;

/// <summary>
/// This implementation retrieves values persisted by the WebServerPrerenderStateService in EventModular.Server.Web.Services.
