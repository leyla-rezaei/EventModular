using System.IO;
using EventModular.Shared.Controllers;
using EventModular.Shared.Controllers.Categories;
using EventModular.Shared.Controllers.Products;
using EventModular.Shared.Dtos.Products;

namespace EventModular.Client.Core.Components.Pages.Products;
