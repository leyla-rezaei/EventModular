...
using EventModular.Client.Core.Styles;
using EventModular.Client.Maui.Services;
...
public static partial class MauiProgram
{
    public static MauiApp CreateMauiApp()
    {
        ...
        var builder = MauiApp.CreateBuilder();
            ...
            .UseSentry(options =>
            {
                var configuration = new ConfigurationBuilder().AddClientConfigurations(clientEntryAssemblyName: "EventModular.Client.Maui").Build();
                configuration.GetRequiredSection("Logging:Sentry").Bind(options);
            })
            .Configuration.AddClientConfigurations(clientEntryAssemblyName: "EventModular.Client.Maui");
        ...
        mauiApp.Services.GetRequiredService<PubSubService>()
            .Subscribe(ClientPubSubMessages.PAGE_DATA_CHANGED, async (args) =>
            {
                ...
                {
                    Application.Current!.Windows.First().Title = title ?? "EventModular";
                });
            });
